...
export default class BannerForm extends React.Component {
  ...
  submitInfo = () => {
    ...
    this.field.validate((error, values) => {
      error || onSubmitInfo(this.formatUploadInfo(values))
    })
  }
  ...
  formatUploadInfo = values => {
    return {
      ...
      id: values.bannerFile[0].response ? values.bannerFile[0].response.id : values.bannerFile[0].id,
    }
  }
